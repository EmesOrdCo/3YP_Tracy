...
Several platforms were evaluated, including STM32\cite{stm32-nucleo-f4}, Arduino Uno\cite{Arduino_uno_data_sheet}, TI C2000\cite{TI_C200_data_sheet}, NXP S32K\cite{NPX_S32K_data_sheet}, and Speedgoat/dSPACE systems\cite{Speedgoat_data_sheet}.
...
\begin{figure}
    \centering
    \includegraphics[width=0.5\linewidth]{微信图片_20260502132647_463_62.jpg}
    \caption{Accumulator Isolation Relay}
    \label{fig:AIR}
\end{figure}
...
The transmission ratio is determined from simulation by Harri, with a final drive ratio of 5.5:1 selected to balance torque and speed for the acceleration event. Lightweight materials are used to minimise system mass while maintaining sufficient strength.
