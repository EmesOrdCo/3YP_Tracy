...
Nelder--Mead over \num{243} evaluations reaches \SI{3.67}{\second} from a \SI{3.78}{\second} baseline under FS-EV~2.2, FS-D~5.3.1, and positive front load (Section~\ref{sec:optimisation}); wet grip scaling preserves the same compliance (Section~\ref{sec:drywet}).
