...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{figures/powertrain_block_diagram_1.png}
...
\begin{figure}
    \centering
    \includegraphics[width=0.5\linewidth]{figures/YASA_Motor_Operation_Graph.png}
...
\begin{figure}
        \centering
        \includegraphics[width=0.5\linewidth]{figures/Block_Diagram_for_Control_System.png}
...
\begin{figure}
    \centering
    \includegraphics[width=0.5\linewidth]{figures/Shutdown_Circuit_Design.png}
...
achievex the highest overall score due to its low mass and adequate torque capability. Therefore, it is selected as the most suitable differential for the drivetrain system.
