...
\subsubsection{Strategic Objective}
...
\subsection{Supply Chain Planning}

\subsubsection{Planning Framework}
...
\subsubsection{Failure Mode and Effect Analysis (FEMA)}

To support the planning framework, a structured failure analysis is carried out using a simplified Failure Mode and Effects Analysis (FMEA). Rather than focusing solely on downtime, this approach allows different failure modes to be linked to their likelihood, underlying causes, and operational impact.
...
A detailed FMEA covering other subsystems is provided in the appendix.
...
\begin{figure}
    \centering
    \includegraphics[width=0.5\linewidth]{Conceptual_classification_of_component_risk.png}
...
\begin{figure}
    \centering
    \includegraphics[width=0.5\linewidth]{non_collision.png}
...
\begin{figure}
    \centering
    \includegraphics[width=0.5\linewidth]{collision.png}
    \caption{Component classification under collision conditions}
    \label{fig:collision}
\end{figure}

\subsubsection{Spare Strategy}
...
\subsection{Supply Chain Operation}

\subsubsection{Operational Flow}

\begin{figure}
    \centering
    \includegraphics[width=0.5\linewidth]{operation.png}
    \caption{Operational cycle and support structure}
    \label{fig:operation}
\end{figure}
...
\subsubsection{Process Behaviour}
...
\subsubsection{Downtime and Performance Constraints}
...
From a customer value perspective, the test execution phase represents the primary value-added activity, while recharge, pre-test setup, and recovery constitute non-value-added time, despite being necessary for operation.
...
Space is reserved for references and any unexpected changes.
